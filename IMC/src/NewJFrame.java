...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       Persona obj = new Persona();  // TODO add your handling code here:
        ...
        String Cname = String.valueOf(Name.getText());//captura Nombre
        String Cname2 =String.valueOf(Lastname.getText());//capura Apellido
        Complet_name.setText(Cname +"  "+ Cname2);//Envia nombre+apellido
        float Estature=Float.valueOf(Estatura.getText());//obtener Estatura
        float Pesc = Float.valueOf(Peso.getText());//obtener Peso
        String Bird=String.valueOf(Age.getText());//obtener Fecha Nacimiento
        obj.setEstatura(Estature);
        obj.setPeso(Pesc);
        obj.setFecha_de_nacimiento(Bird);
        I.setText(obj.getDiagnostico().toUpperCase());//Obtener desde la clase el mensaje segun condicion
        IMC_Final.setText( Double.toString(obj.getImc()));//Obtener El Valor imc desde la clase
        Edad_Final.setText(Integer.toString(obj.getEdad()));//Obtener la edad desde la clase
